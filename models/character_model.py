...
class CHARACTERModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D', 'D_lexicon', 'D_ID', 'D_radical_ID', 'unetD_middle_real', 'D_real_lexicon_feat', 'unetD_middle_fake', 'D_fake_lexicon_feat',
                            'G', 'G_lexicon','G_ID','G_radical_ID','unetG_middle','G_lexicon_feat','G_idt','G_cont_idt']
