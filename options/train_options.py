...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=160,
        ...
        parser.add_argument('--print_freq', type=int, default=160,
                            help='frequency of showing training results on console')
        parser.add_argument('--no_html', action='store_true',
                            help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.name]/web/')
        # network saving and loading parameters
        parser.add_argument('--save_latest_freq', type=int, default=4000,
        ...
        parser.add_argument('--lr_decay_iters', type=int, default=30,
                            help='multiply by a gamma every lr_decay_iters iterations for linear policy')
        ...
        parser.add_argument('--dictionaryRoot', type=str,
                            required=True, help='path to radical_dictionary')
        parser.add_argument('--val_seenstyleRoot', type=str,
                            required=False, help='path to seenstyle_oov list')
        parser.add_argument('--val_unseenstyleRoot', type=str,
                            required=False, help='path to unseenstyle_oov list')
        self.isTrain = True
