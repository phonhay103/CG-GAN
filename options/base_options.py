...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ttfRoot', type=str,  help='path to font .ttf')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='handwritten',
                            help='chooses which model to use. [handwritten]')
        parser.add_argument('--input_nc', type=int, default=3,
                            help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc', type=int, default=3,
                            help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--D_ch', type=int, default=64,
                            help='output channels of unetD in the first conv layer')
        parser.add_argument('--G_ch', type=int, default=64,
                            help='output channels of unetG in the first conv layer')
        ...
        parser.add_argument('--num_writer', type=int,
                            default=1, help='number of writers')
        # dataset parameters
        parser.add_argument('--num_threads', default=4,
                            type=int, help='# threads for loading data')
        parser.add_argument('--batch_size', type=int,
                            default=2, nargs='+', help='input batch size > 1')
        parser.add_argument('--imgH', type=int, default=64,
                            help='scale images to this size')
        parser.add_argument('--imgW', type=int, default=384,
                            help='scale images to this size')
